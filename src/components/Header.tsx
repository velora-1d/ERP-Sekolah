    ...
    <header className="h-16 flex items-center justify-between px-6 flex-shrink-0 border-b border-slate-200/80 bg-white/80 backdrop-blur-xl z-30 relative">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          title="Pusat Bantuan"
          className="w-9 h-9 flex items-center justify-center rounded-xl text-slate-400 hover:bg-indigo-50 hover:text-indigo-600 transition-colors cursor-pointer"
        >
