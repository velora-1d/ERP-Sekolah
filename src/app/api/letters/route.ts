...
export async function POST(req: Request) {
  try {
    ...
    const { type, subject, sender, receiver, date, fileUrl, status, academicYearId, semester, month } = body;
    ...
    const [data] = await db
      ...
      .values({
        ...
        academicYearId: academicYearId ? parseInt(String(academicYearId)) : null,
