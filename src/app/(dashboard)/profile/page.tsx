...
export default function ProfilePage() {
  ...
  return (
    <div className="space-y-5 animate-fade-in-up">
      <PageHeader title="Profil Pengguna" subtitle="Kelola informasi akun dan keamanan Anda." icon={<ProfileIcon />} gradient="from-indigo-600 via-purple-600 to-purple-400" />
